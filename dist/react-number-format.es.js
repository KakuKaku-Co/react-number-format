 ...
 * Author : Sakamoto Junya
 * Copyright (c) 2016, 2023 to Sakamoto Junya, released under the MIT license.
 * https://github.com/KakuKaku-Co/react-number-format
 */
...
function NumberFormatBase(props) {
    ...
    var _onChange = function (e) {
        var el = e.target;
        var inputValue = toHalfWidth(el.value);
    ...
    var _onKeyDown = function (e) {
        ...
        var value = toHalfWidth(el.value);
